  ...
  win = {
    ...
    input = {
      keys = {
        ...
        -- ["<Esc>"] = { "close", mode = { "n", "i" } },
        ["/"] = { "toggle_focus", desc = "Focus list" },
        ["<C-Down>"] = { "history_forward", mode = { "i", "n" }, desc = "Next history item" },
        ["<C-Up>"] = { "history_back", mode = { "i", "n" }, desc = "Prev. history item" },
        ["<C-c>"] = { "cancel", mode = "i", desc = "Cancel" },
        ["<C-w>"] = { "<c-s-w>", mode = { "i" }, expr = true, desc = "Delete word" },
        ["<CR>"] = { "confirm", mode = { "n", "i" }, weight = 100, desc = "Confirm" },
        ["<Down>"] = { "list_down", mode = { "i", "n" }, desc = "Next item" },
        ["<Esc>"] = { "cancel", weight = 90, desc = "Cancel" },
        ["<S-CR>"] = { { "pick_win", "jump" }, mode = { "n", "i" }, desc = "Open in window" },
        ["<S-Tab>"] = { "select_and_prev", mode = { "i", "n" }, weight = 70, desc = "Select & Prev." },
        ["<Tab>"] = { "select_and_next", mode = { "i", "n" }, weight = 70, desc = "Select & next" },
        ["<Up>"] = { "list_up", mode = { "i", "n" }, desc = "Prev. item" },
        ...
        ["<c-g>"] = { "toggle_live", mode = { "i", "n" }, desc = "Toggle live search" },
        ["<c-j>"] = { "list_down", mode = { "i", "n" }, desc = "Next item" },
        ["<c-k>"] = { "list_up", mode = { "i", "n" }, desc = "Prev. item" },
        ["<c-n>"] = { "list_down", mode = { "i", "n" }, desc = "Next item" },
        ["<c-p>"] = { "list_up", mode = { "i", "n" }, desc = "Prev. item" },
        ["<c-q>"] = { "qflist", mode = { "i", "n" }, desc = "Send to quickfix" },
        ["<c-s>"] = { "edit_split", mode = { "i", "n" }, weight = 80, desc = "Open in split" },
        ["<c-t>"] = { "tab", mode = { "n", "i" }, weight = 80, desc = "Open in tab" },
        ["<c-u>"] = { "list_scroll_up", mode = { "i", "n" }, desc = "List scroll up" },
        ["<c-v>"] = { "edit_vsplit", mode = { "i", "n" }, desc = "Open in vsplit" },
        ["<c-r>#"] = { "insert_alt", mode = "i", desc = "Insert alternate" },
        ["<c-r>%"] = { "insert_filename", mode = "i", desc = "Insert filename" },
        ["<c-r><c-a>"] = { "insert_cWORD", mode = "i", desc = "Insert WORD" },
        ["<c-r><c-f>"] = { "insert_file", mode = "i", desc = "Insert file" },
        ["<c-r><c-l>"] = { "insert_line", mode = "i", desc = "Insert line" },
        ["<c-r><c-p>"] = { "insert_file_full", mode = "i", desc = "Insert full path" },
        ["<c-r><c-w>"] = { "insert_cword", mode = "i", desc = "Insert word" },
        ...
        ["?"] = { "toggle_help_input", weight = 10, desc = "Help" },
        ["G"] = { "list_bottom", desc = "Go to last" },
        ["gg"] = { "list_top", desc = "Go to first" },
    ...
    list = {
      keys = {
        ["/"] = { "toggle_focus", desc = "Focus input" },
        ["<2-LeftMouse>"] = { "confirm", weight = 100, desc = "Confirm" },
        ["<CR>"] = { "confirm", weight = 100, desc = "Confirm" },
        ["<Down>"] = { "list_down", desc = "Next item" },
        ["<Esc>"] = { "cancel", weight = 90, desc = "Cancel" },
        ["<S-CR>"] = { { "pick_win", "jump" }, desc = "Open in window" },
        ["<S-Tab>"] = { "select_and_prev", mode = { "n", "x" }, weight = 70, desc = "Select & Prev." },
        ["<Tab>"] = { "select_and_next", mode = { "n", "x" }, weight = 70, desc = "Select & next" },
        ["<Up>"] = { "list_up", desc = "Prev. item" },
        ["<a-d>"] = { "inspect", desc = "Inspect item" },
        ["<a-f>"] = { "toggle_follow", desc = "Toggle follow" },
        ["<a-h>"] = { "toggle_hidden", desc = "Toggle hidden" },
        ["<a-i>"] = { "toggle_ignored", desc = "Toggle ignored" },
        ...
        ["<c-b>"] = { "preview_scroll_up", desc = "Preview scroll up" },
        ["<c-d>"] = { "list_scroll_down", desc = "List scroll down" },
        ["<c-f>"] = { "preview_scroll_down", desc = "Preview scroll down" },
        ["<c-j>"] = { "list_down", desc = "Next item" },
        ["<c-k>"] = { "list_up", desc = "Prev. item" },
        ["<c-n>"] = { "list_down", desc = "Next item" },
        ["<c-p>"] = { "list_up", desc = "Prev. item" },
        ["<c-q>"] = { "qflist", desc = "Send to quickfix" },
        ["<c-g>"] = { "print_path", desc = "Print file path" },
        ["<c-s>"] = { "edit_split", weight = 80, desc = "Open in split" },
        ["<c-t>"] = { "tab", weight = 80, desc = "Open in tab" },
        ["<c-u>"] = { "list_scroll_up", desc = "List scroll up" },
        ["<c-v>"] = { "edit_vsplit", weight = 80, desc = "Open in vsplit" },
        ["<c-w>H"] = { "layout_left", desc = "Layout left" },
        ["<c-w>J"] = { "layout_bottom", desc = "Layout bottom" },
        ["<c-w>K"] = { "layout_top", desc = "Layout top" },
        ["<c-w>L"] = { "layout_right", desc = "Layout right" },
        ["?"] = { "toggle_help_list", weight = 10, desc = "Help" },
        ["G"] = { "list_bottom", desc = "Go to last" },
        ["gg"] = { "list_top", desc = "Go to first" },
